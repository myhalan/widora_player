...
class LiZhiFM(object):
    ...
    def SubSaveCover(self, url):
        ...
        img.thumbnail((200, 200), resample=Image.ANTIALIAS)
        img.save(str(cover_content.attrs["alt"]).decode("string_escape") + "/Subject Cover", "JPEG")
